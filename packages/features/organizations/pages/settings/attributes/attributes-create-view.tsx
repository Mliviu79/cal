...
/**
 * OSS replacement for organization attributes create page
 * This provides a stub implementation without EE dependencies
 */

import { useLocale } from "@calcom/lib/hooks/useLocale";

export default function OrgAttributesCreatePage() {
  const { t } = useLocale();

  return (
    <div className="max-w-lg">
      <h1 className="font-cal text-xl tracking-wide text-gray-900">{t("create_attribute")}</h1>
